...
| `ACTION_SEND` / `ACTION_SEND_MULTIPLE` with `content` URIs | [android-security.md → Forward-compatible URI grants (Android 18 prep)](android-security.md#forward-compatible-uri-grants-android-18-prep) |
